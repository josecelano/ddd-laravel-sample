    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="frontend-navbar-collapse">
            <ul class="nav navbar-nav">
                <li>{{ link_to_route('frontend.dishwashers', trans('appliances.category.dishwashers')) }}</li>
                <li>{{ link_to_route('frontend.small.appliances', trans('appliances.category.small_appliances')) }}</li>
            </ul>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                @if ($logged_in_user)
                    <li>{{ link_to_route('frontend.wishlist', trans('navs.frontend.wishlist'), [ 'userId' => $logged_in_user]) }}</li>
                @endif
